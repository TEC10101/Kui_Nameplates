...
-- TC Changed : Check if display exists first (prevents crash)
if mod.db and mod.db.profile and mod.db.profile.display and mod.db.profile.display.hidecastbars then
